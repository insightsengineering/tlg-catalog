...
app <- init(
  ...
  modules = modules(
    tm_g_forest_tte(
      ...
      subgroup_var = teal.transform::choices_selected(names(ADSL), c("SEX", "BMRKR2")),
      paramcd = teal.transform::choices_selected(value_choices(ADTTE, "PARAMCD", "PARAM"), "OS"),
      strata_var = teal.transform::choices_selected(c("STRATA1", "STRATA2"), "STRATA2"),
