...
```{r plot1, test = list(plot_v1 = "plot"), fig.width = 20, fig.height = 5, opts.label = ifelse(packageVersion("survival") < "3.5-8", "skip_test_strict", "")}
...
<!-- skip strict because of https://github.com/therneau/survival/issues/240 -->
```{r plot2, test = list(plot_v2 = "plot"), fig.width = 20, fig.height = 5, opts.label = ifelse(packageVersion("survival") < "3.5-8", "skip_test_strict", "")}
...
<!-- skip strict because of https://github.com/therneau/survival/issues/240 -->
```{r plot3, test = list(plot_v3 = "plot"), fig.width = 10, fig.height = 4, opts.label = ifelse(packageVersion("survival") < "3.5-8", "skip_test_strict", "")}
df <- extract_rsp_subgroups(
  variables = list(
    rsp = "is_rsp",
    arm = "ARM",
...
<!-- skip strict because of https://github.com/therneau/survival/issues/240 -->
```{r plot4, test = list(plot_v4 = "plot"), fig.width = 20, fig.height = 5, opts.label = ifelse(packageVersion("survival") < "3.5-8", "skip_test_strict", "")}
df <- extract_rsp_subgroups(
  variables = list(
    rsp = "is_rsp",
    arm = "ARM",
...
<!-- skip strict because of https://github.com/therneau/survival/issues/240 -->
```{r plot5, test = list(plot_v5 = "plot"), fig.width = 20, fig.height = 5, opts.label = ifelse(packageVersion("survival") < "3.5-8", "skip_test_strict", "")}
anl_cr_arms_ab <- anl %>%
