...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot3, test = list(plot_v3 = "g3"), opts.label = c('skip_test_strict')}
g3 <- g2 + theme(
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot51, test = list(plot_v51 = "plot"), opts.label = c('skip_test_strict')}
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot52, test = list(plot_v52 = "plot"), opts.label = c('skip_test_strict')}
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot53, test = list(plot_v53 = "plot"), opts.label = c('skip_test_strict')}
