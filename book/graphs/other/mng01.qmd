...
```{r plot1, test = list(plot_v1 = "plot"), opts.label = c('skip_test_strict')}
plot <- g_lineplot(
  df = adlb_f,
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot2, test = list(plot_v2 = "plot"), opts.label = c('skip_test_strict')}
plot <- g_lineplot(
  df = advs_f,
  alt_counts_df = adsl_f,
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot3, test = list(plot_v3 = "plot"), opts.label = c('skip_test_strict')}
plot <- g_lineplot(
  df = adlb_f,
  alt_counts_df = adsl_f,
  interval = "mean_sdi",
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot4, test = list(plot_v4 = "plot"), opts.label = c('skip_test_strict')}
plot <- g_lineplot(
  df = adlb_f,
  alt_counts_df = adsl_f,
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot6, fig.height = 8, test = list(plot_v6 = "plot"), opts.label = c('skip_test_strict')}
plot <- g_lineplot(
  df = adlb_f,
  alt_counts_df = adsl_f,
...
<!-- skip strict because of https://github.com/r-lib/gtable/pull/94 -->
```{r plot7, test = list(plot_v7 = "plot"), opts.label = c('skip_test_strict')}
plot <- g_lineplot(
  df = adlb_f,
  alt_counts_df = adsl_f,
