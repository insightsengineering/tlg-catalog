  ...
  modules = modules(
    tm_g_ipp(
      ...
      arm_var = choices_selected(
        value_choices(data[["ADLB"]], c("ARMCD")),
        "ARM A"
      ),
      paramcd = choices_selected(
        value_choices(data[["ADLB"]], "PARAMCD"),
        "ALT"
      ),
      aval_var = choices_selected(
        variable_choices(data[["ADLB"]], c("AVAL")),
        "AVAL"
      ),
      avalu_var = choices_selected(
        variable_choices(data[["ADLB"]], c("AVALU")),
        "AVALU",
        fixed = TRUE
      ),
      id_var = choices_selected(
        variable_choices(data[["ADLB"]], c("USUBJID")),
        "USUBJID",
        fixed = TRUE
      ),
      visit_var = choices_selected(
        variable_choices(data[["ADLB"]], c("AVISIT")),
        "AVISIT"
      ),
      base_var = choices_selected(
        variable_choices(data[["ADLB"]], c("BASE")),
        "BASE",
        fixed = TRUE
      ),
