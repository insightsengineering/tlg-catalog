...
`r webr_code_labels <- c("setup1", "variant1")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup2", "variant1")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup3", "variant3")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup4", "variant4")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup5", "variant5")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup6", "variant6")` {{< include ../../_utils/webr.qmd >}}
:::
