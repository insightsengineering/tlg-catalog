...
`r webr_code_labels <- c("setup", "variant1", "variant2")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant6")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant7")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant8")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant9")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant10")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant11")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant12")` {{< include ../../_utils/webr.qmd >}}
:::
...
`r webr_code_labels <- c("setup", "variant13")` {{< include ../../_utils/webr.qmd >}}
:::
