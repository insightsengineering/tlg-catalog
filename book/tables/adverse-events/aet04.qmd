...
```{r testenv setup, echo=FALSE, message=FALSE}
tenv <- new.env()
```
...
```{r save result_v1, echo=FALSE, message=FALSE}
tenv$result_v1 <- result
```
...
```{r save result_v2, echo=FALSE, message=FALSE}
tenv$result_v2 <- result
```
...
```{r save result_v3, echo=FALSE, message=FALSE}
tenv$result_v3 <- result
```
...
```{r save result_v4, echo=FALSE, message=FALSE}
tenv$result_v4 <- result
```
...
```{r save result_v6, echo=FALSE, message=FALSE}
tenv$result_v6 <- result
```
...
```{r save result_v8, echo=FALSE, message=FALSE}
tenv$result_v8 <- result
```
...
```{r save result_v9, echo=FALSE, message=FALSE}
tenv$result_v9 <- result
```
...
```{r save result_v11, echo=FALSE, message=FALSE}
tenv$result_v11 <- result
```

```{r save testenv, echo=FALSE, message=FALSE, cache=FALSE}
...
knitr::opts_chunk$set(eval = isFALSE(testthat::is_checking() || testthat::is_testing()))
