...
```{r save testenv, echo=FALSE, message=FALSE, cache=FALSE, eval=isTRUE(testthat::is_checking() || testthat::is_testing())}
...
```{r teal, message=FALSE, eval=isFALSE(testthat::is_checking() || testthat::is_testing())}
