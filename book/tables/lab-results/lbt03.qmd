  ...
  modules = modules(
    tm_t_summary_by(
      ...
      by_vars = choices_selected(
        choices = variable_choices(data[["ADLB"]], c("PARAM", "AVISIT_header")), # note: order matters here. If `PARAM` is first, the split will be first by `PARAM`and then by `AVISIT`
        selected = c("PARAM", "AVISIT_header")
      ),
      summarize_vars = choices_selected(
        choices = variable_choices(data[["ADLB"]], c("AVAL", "CHG", "AVAL_CHG")),
        selected = c("AVAL_CHG")
      ),
      useNA = "ifany",
