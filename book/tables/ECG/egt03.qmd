  ...
  modules = modules(
    tm_t_shift_by_arm(
      ...
      arm_var = choices_selected(
        variable_choices(data[["ADSL"]], subset = c("ARM", "ARMCD")),
        selected = "ARM"
      ),
      paramcd = choices_selected(
        value_choices(data[["ADEG"]], "PARAMCD"),
        selected = "HR"
      ),
      visit_var = choices_selected(
        value_choices(data[["ADEG"]], "AVISIT"),
        selected = "POST-BASELINE MINIMUM"
      ),
      aval_var = choices_selected(
        variable_choices(data[["ADEG"]], subset = "ANRIND"),
        selected = "ANRIND", fixed = TRUE
      ),
      base_var = choices_selected(
        variable_choices(data[["ADEG"]], subset = "BNRIND"),
        selected = "BNRIND", fixed = TRUE
      ),
      treatment_flag_var = choices_selected(
        variable_choices(data[["ADEG"]], subset = "ONTRTFL"),
        selected = "ONTRTFL", fixed = TRUE
      ),
      treatment_flag = choices_selected(
        value_choices(data[["ADEG"]], "ONTRTFL"),
