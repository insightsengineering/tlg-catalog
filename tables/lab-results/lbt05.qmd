...
```{r variant 1}
# remove all marked abrnormalities for ALT so that it can be demonstrated that
...
# This variant reflects user modifications made to the laboratory analysis data set related to Safety Lab Standardisation metadata.
